...
class TestDBHandler(unittest.TestCase):
    ...
    def test_get_cbi(self):
        ...
        self.assertEqual(self.db_handler.get_cbi(result.inserted_id),
    ...
    def test_get_cba(self):
        ...
        self.assertEqual(self.db_handler.get_cba(result.inserted_id),
                         utils.deunderscore_id(test_dict))
    ...
    def test_get_cbp(self):
        ...
        self.assertEqual(self.db_handler.get_cbp(result.inserted_id),
                         utils.deunderscore_id(test_dict))
    ...
    def test_get_cbr(self):
        ...
        self.assertEqual(self.db_handler.get_cbr(result.inserted_id),
                         utils.deunderscore_id(test_dict))
